...
export default function Uploader({ token, days = [], tripId = "", tripPath = "" }) {
  ...
  return (
    <form className="storyform" onSubmit={send}>
      ...
      <p className="note keepnote">
        <b>מה נשמר אצלנו:</b> תמונות — גם באיכות המלאה שצילמתם, לתמיד.
        סרטונים — באיכות צפייה טובה בלבד; הקובץ המקורי לא נשמר אצלנו, אז אל תמחקו
        אותו מהטלפון. (בהמשך תהיה אפשרות לשמור גם סרטונים במקור.)
      </p>
